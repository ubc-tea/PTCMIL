...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    elif args.model_type == 'ptcmil':
        # from models.model_vit_pmt_clus_survival import ViT_PMT_CLU
    ...
    for epoch in range(args.start_epoch,args.max_epochs):
        ...
        if c_index_val > max_c_index:
            ...
            # print(os.path.join(args.results_dir))
            # print( os.path.join(args.results_dir, save_name+".pt".format(cur)))
            # assert 2==3
