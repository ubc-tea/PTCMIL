...
if __name__ == '__main__':
    path = './splits/survival/TCGA_'
    save_path = './dataset_csv/tcga_'
    dataset = [ 'NSCLC' ]
    get_all_csv_file(path, save_path, dataset)
    save_path = './splits/5foldcv/tcga'
    
    get_kfolds(path, save_path, dataset)
